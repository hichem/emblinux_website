...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->x->none->max_lat);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->x->video->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->x->burn->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->x->write->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->x->read->max_lat);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->x->compile->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->x->memload->max_lat);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of x in the presence of simulated None -Mesuring max_lat-");
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of x in the presence of simulated video -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of x in the presence of simulated burn -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of x in the presence of simulated write -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of x in the presence of simulated Read -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of x in the presence of simulated Compile -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of x in the presence of simulated Memload -Mesuring max_lat-");
// TITRE: marge et apparence
