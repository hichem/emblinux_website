...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->audio->none->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->audio->video->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->audio->x->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->audio->burn->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->audio->write->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->audio->read->dead);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->audio->compile->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->audio->memload->dead);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated None -Mesuring Deadline met-");
...
$graph1->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph1->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Video -Deadline met-");
// TITRE: marge et apparence
...
$graph2->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated X -Mesuring Deadline met-");
// TITRE: marge et apparence
...
$graph3->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated burn -Mesuring Deadline met-");
// TITRE: marge et apparence
...
$graph4->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated write -Mesuring Deadline met-");
// TITRE: marge et apparence
...
$graph5->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Read -Mesuring Deadline met-");
// TITRE: marge et apparence
...
$graph6->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Compile -Mesuring Deadline met-");
// TITRE: marge et apparence
...
$graph7->yaxis->title->Set('Pourcentage(%)');
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Memload -Mesuring Deadline met-");
// TITRE: marge et apparence
