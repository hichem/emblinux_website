...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->audio->none->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->audio->video->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->audio->x->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->audio->burn->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->audio->write->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->audio->read->sd);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->audio->compile->sd);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->audio->memload->sd);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated None -Mesuring SD-");
...
// TITRE: texte
$graph1->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Video -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated X -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated burn -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated write -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Read -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Compile -Mesuring SD-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of Audio in the presence of simulated Memload -Mesuring SD-");
// TITRE: marge et apparence
