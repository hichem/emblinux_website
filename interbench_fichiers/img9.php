...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->video->none->cpu);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->video->x->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->video->burn->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->video->write->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->video->read->cpu);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->video->compile->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->video->memload->cpu);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of video in the presence of simulated None -Mesuring cpu-");
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of video in the presence of simulated X -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of video in the presence of simulated burn -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of video in the presence of simulated write -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of video in the presence of simulated Read -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of video in the presence of simulated Compile -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of video in the presence of simulated Memload -Mesuring cpu-");
// TITRE: marge et apparence
