...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->video->none->dead);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->video->x->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->video->burn->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->video->write->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->video->read->dead);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->video->compile->dead);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->video->memload->dead);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of video in the presence of simulated None -Mesuring Deadline met-");
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of video in the presence of simulated X -Mesuring Deadline met-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of video in the presence of simulated burn -Mesuring Deadline met-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of video in the presence of simulated write -Mesuring Deadline met-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of video in the presence of simulated Read -Mesuring Deadline met-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of video in the presence of simulated Compile -Mesuring Deadline met-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of video in the presence of simulated Memload -Mesuring Deadline met-");
// TITRE: marge et apparence
