...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->gaming->none->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->gaming->video->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->gaming->x->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->gaming->burn->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->gaming->write->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->gaming->read->cpu);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->gaming->compile->cpu);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->gaming->memload->cpu);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated None -Mesuring cpu-");
...
// TITRE: texte
$graph1->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Video -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated X -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated burn -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated write -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Read -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Compile -Mesuring cpu-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Memload -Mesuring cpu-");
// TITRE: marge et apparence
