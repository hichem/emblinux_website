...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->gaming->none->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->gaming->video->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->gaming->x->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->gaming->burn->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data5[$i]=(float)($xml[$i]->gaming->write->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data6[$i]=(float)($xml[$i]->gaming->read->max_lat);
}

for($i=0;$i<$max_rep;$i++)
{ 
$data7[$i]=(float)($xml[$i]->gaming->compile->max_lat);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data8[$i]=(float)($xml[$i]->gaming->memload->max_lat);
}
//graphique1
...
// TITRE: texte
$graph->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated None -Mesuring max_lat-");
...
// TITRE: texte
$graph1->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Video -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph2->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated X -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated burn -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph4->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated write -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph5->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Read -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph6->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Compile -Mesuring max_lat-");
// TITRE: marge et apparence
...
// TITRE: texte
$graph7->title->Set("Benchmarking simulated cpu of gaming in the presence of simulated Memload -Mesuring max_lat-");
// TITRE: marge et apparence
