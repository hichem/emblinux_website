...
for($i=0;$i<$max_rep;$i++)
{ if (strcmp($xml[$i]->double_operation->double_add,"      ")==0)
{$data1[$nom_dir[$i]][0]=0;}
else{$data1[$nom_dir[$i]][0]=(float)($xml[$i]->double_operation->double_add);}
if (strcmp($xml[$i]->double_operation->float_double,"      ")==0)
{$data1[$nom_dir[$i]][1]=0;}
else{$data1[$nom_dir[$i]][1]=(float)($xml[$i]->double_operation->double_mul);}
if (strcmp($xml[$i]->double_operation->double_div,"      ")==0)
{$data1[$nom_dir[$i]][2]=0;}
else{$data1[$nom_dir[$i]][2]=(float)($xml[$i]->double_operation->double_div);}
if(strcmp($xml[$j]->double_operation->double_bog,"      ")==0)
{$data1[$nom_dir[$i]][3]=0;}
else{$data1[$nom_dir[$i]][3]=(float)($xml[$i]->double_operation->double_bog);}
}
...
// TITRE: texte
$graph->title->Set(" Basic double operations - times in nanoseconds-");
