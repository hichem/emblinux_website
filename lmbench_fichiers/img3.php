...
for($i=0;$i<$max_rep;$i++)
{ 
if(strcmp($xml[$i]->int64_operation->int64_bit,"      ")==0)
{$data1[$i]=0;}
else{$data1[$i]=(float)($xml[$i]->int64_operation->int64_bit);}
}
for($i=0;$i<$max_rep;$i++)
{
if(strcmp($xml[$i]->int64_operation->uint64_add,"      ")==0)
{$data2[$i]=0;}
else{$data2[$i]=(float)($xml[$i]->int64_operation->uint64_add);}
}
for($i=0;$i<$max_rep;$i++)
{
if (strcmp($xml[$i]->int64_operation->int64_mul,"      ")==0)
{$data3[$i]=0;}
else{$data3[$i]=(float)($xml[$i]->int64_operation->int64_mul);}
}

for($i=0;$i<$max_rep;$i++)
{
if (strcmp($xml[$i]->int64_operation->int64_div,"      ")==0)
{$data4[$i]=0;}
else{$data4[$i]=(float)($xml[$i]->int64_operation->int64_div);}
}
for($i=0;$i<$max_rep;$i++)
{
if(strcmp($xml[$i]->int64_operation->int64_mod,"      ")==0)
{$data5[$i]=0;}
else{$data5[$i]=(float)($xml[$i]->int64_operation->int64_mod);}
}
