...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->Periodic_cpu_load_single->time_statistics->min);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->Periodic_cpu_load_single->time_statistics->max);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->Periodic_cpu_load_single->time_statistics->avg);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->Periodic_cpu_load_single->time_statistics->stddev);
}
...
// TITRE: texte
$graph->title->Set("Periodic_cpu_load_single -Mesuring Min(us)-");
...
// TITRE: texte
$graph1->title->Set("Periodic_cpu_load_single -Mesuring Max(us)");
// TITRE: marge et apparence
...
// TITRE: texte
$graph2->title->Set("Periodic_cpu_load_single -Mesuring Average(us)");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Periodic_cpu_load_single -Mesuring Standard Deviation(us)");
// TITRE: marge et apparence
