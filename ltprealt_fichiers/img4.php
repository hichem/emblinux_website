...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->Matrix_Mult->Min_seq);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->Matrix_Mult->Max_seq);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->Matrix_Mult->Avg_seq);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->Matrix_Mult->Stddev_seq);
}
...
// TITRE: texte
$graph->title->Set("Running sequential operations -Mesuring Min(us)-");
...
// TITRE: texte
$graph1->title->Set("Running sequential operations -Mesuring Max(us)");
// TITRE: marge et apparence
...
// TITRE: texte
$graph2->title->Set("Running sequential operations -Mesuring Average(us)");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Running sequential operations -Mesuring Standard Deviation(us)");
// TITRE: marge et apparence
