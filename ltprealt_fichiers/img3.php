...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)($xml[$i]->Gtod_latency->min);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)($xml[$i]->Gtod_latency->max);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)($xml[$i]->Gtod_latency->avg);
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)($xml[$i]->Gtod_latency->stddev);
}
...
$graph->yaxis->title->Set('time(ns)');
$graph->yaxis->title->SetFont(FF_FONT1,FS_BOLD);
$graph->ygrid->SetColor('black');
$graph->yaxis->SetTitleMargin(45);
$graph->yaxis->scale->SetGrace(30);
// TITRE: texte
$graph->title->Set("Async_Handler Results -Mesuring Min(ns)-");
...
$graph1->yaxis->title->Set('time(ns)');
...
// TITRE: texte
$graph1->title->Set("Async_Handler Results -Mesuring Max(ns)");
// TITRE: marge et apparence
...
$graph2->yaxis->title->Set('time(ns)');
...
// TITRE: texte
$graph2->title->Set("Async_Handler Results -Mesuring Average(ns)");
// TITRE: marge et apparence
...
$graph3->yaxis->title->Set('time(ns)');
...
// TITRE: texte
$graph3->title->Set("Async_Handler Results -Mesuring Standard Deviation(ns)");
// TITRE: marge et apparence
