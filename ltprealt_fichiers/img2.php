...
for($i=0;$i<$max_rep;$i++)
{ 
$data1[$i]=(float)(str_replace("us","  ",(string)($xml[$i]->Async_Handler->min)));
}
for($i=0;$i<$max_rep;$i++)
{ 
$data2[$i]=(float)(str_replace("us","  ",(string)($xml[$i]->Async_Handler->max)));
}
for($i=0;$i<$max_rep;$i++)
{ 
$data3[$i]=(float)(str_replace("us","  ",(string)($xml[$i]->Async_Handler->avg)));
}
for($i=0;$i<$max_rep;$i++)
{ 
$data4[$i]=(float)(str_replace("us","  ",(string)($xml[$i]->Async_Handler->stddev)));
}
...
// TITRE: texte
$graph->title->Set("Async_Handler Results -Mesuring Min(us)-");
...
// TITRE: texte
$graph1->title->Set("Async_Handler Results -Mesuring Max(us)");
// TITRE: marge et apparence
...
// TITRE: texte
$graph3->title->Set("Async_Handler Results -Mesuring Standard Deviation(us)");
// TITRE: marge et apparence
